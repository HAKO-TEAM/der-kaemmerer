---
title: "Doppik verstehen und nutzen: Warum die meisten Kommunen ihr Potenzial verschenken"
beschreibung: "Fast alle deutschen Kommunen führen heute einen doppischen Haushalt. Genutzt wird er selten. Was Führungskräfte wirklich aus Bilanz, GuV und Anhang lesen können — und sollten."
ressort: haushalt
datum: "2026-06-09"
minuten: 10
autor: Redaktion
...
Was selten passiert:
- Die **Bilanzentwicklung** wird nicht für mehrjährige Steuerungsentscheidungen genutzt
- **Abschreibungsquoten** werden nicht als Signal für Investitionsbedarf interpretiert
- **Eigenkapitalentwicklung** ist kein regulärer Tagesordnungspunkt im Kämmereigespräch
- **Rückstellungen** für Pensionsverpflichtungen werden nicht in die mittelfristige Finanzplanung einbezogen
...
- Sinkende Eigenkapitalquote über mehrere Jahre = strukturelles Defizit, das durch Vermögenssubstanz finanziert wird
- Negative Eigenkapitalquote = Überschuldung (rechnerisch) — in vielen NRW-Kommunen bereits Realität
- Stabile oder steigende Quote = strukturelles Gleichgewicht
...
- Unter 100 %: Die Substanz wird aufgezehrt — der Investitionsstau wächst
- Über 100 %: Substanzerhalt oder -aufbau
...
**Risikoampel:**
- Unter 5 % der Bilanzsumme: unproblematisch
- 5–15 %: erhöhtes Risiko, vor allem bei steigenden Zinsen
- Über 15 %: strukturelles Problem, das haushaltsrechtliche Maßnahmen erfordert
...
| Kennzahl | Vorjahr | Aktuell | Trend |
|---|---|---|---|
| Eigenkapitalquote | 32 % | 29 % | ↓ |
| Abschreibungsdeckung | 78 % | 71 % | ↓ |
| Liquiditätskredite / Bilanzsumme | 8 % | 11 % | ↓ |
| Pensionsrückstellungen gesamt | 42 Mio. € | 44 Mio. € | → |
